...
import { $createParagraphNode, $getRoot, $isRootNode, $isTextNode, $isLineBreakNode } from 'lexical';
...
export function denestTransform(node, createNode) {
...
export function registerDenestTransform(editor, klass, createNode) {
