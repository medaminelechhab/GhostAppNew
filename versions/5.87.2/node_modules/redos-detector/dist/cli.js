...
function buildCharacterClassCharacterReader(_a) {
    ...
    try {
        for (var _e = __values(node.body), _f = _e.next(); !_f.done; _f = _e.next()) {
            ...
            switch (expression.type) {
                ...
                case 'characterClassRange': {
                    (_c = characterGroups.ranges).push.apply(_c, __spreadArray([], __read(buildCodePointRanges({
                        caseInsensitive: caseInsensitive,
                ...
                case 'characterClassEscape': {
                    ...
                    var ranges = characterClassEscapeToRange(value);
                    (_d = characterGroups.ranges).push.apply(_d, __spreadArray([], __read(ranges), false));
                    break;
                }
...
function isEmptyCharacterGroups(group) {
    return (!group.negated && !group.ranges.length && !group.unicodePropertyEscapes.size);
}
...
function buildCheckerReader(input) {
    var sidesEqualChecker, trails, stepCount, latestEndTime, timedOut, initialLeftStreamReader, initialRightStreamReader, stack, _loop_1, state_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                    ...
                    return __generator(this, function (_c) {
                        switch (_c.label) {
                            ...
                            case 3:
                                ...
                                backtrackPossible = void 0;
                                sidesEqual = sidesEqualChecker.areSidesEqual(newEntry.left, newEntry.right);
                                if (sidesEqual) {
                                    backtrackPossible = false;
                                }
                                else {
                                    leftAndRightUnbounded = void 0;
                                    leftUnbounded = void 0;
                                    {
                                ...
                                if (!backtrackPossible) return [3 /*break*/, 5];
...
function collectResults(_a) {
    var atomicGroupOffsets = _a.atomicGroupOffsets, node = _a.node, maxBacktracks = _a.maxBacktracks, maxSteps = _a.maxSteps, multiLine = _a.multiLine, timeout = _a.timeout, caseInsensitive = _a.caseInsensitive, dotAll = _a.dotAll;
...
var description = "A CLI and library which tests with certainty if a regex pattern is safe from ReDoS attacks.";
...
program
    ...
    .option('--maxBacktracks <number>', 'max number of backtracks to allow', toInt, defaultMaxBacktracks)
    ...
    var alwaysIncludeTrails = _a.alwaysIncludeTrails, disableDowngrade = _a.disableDowngrade, json = _a.json, maxBacktracks = _a.maxBacktracks, maxSteps = _a.maxSteps, resultsLimit = _a.resultsLimit, timeout = _a.timeout, caseInsensitive = _a.caseInsensitive, dotAll = _a.dotAll, unicode = _a.unicode, multiLine = _a.multiLine;
    try {
