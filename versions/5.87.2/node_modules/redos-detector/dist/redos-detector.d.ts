...
export type RedosDetectorError = 'hitMaxBacktracks' | 'hitMaxSteps' | 'timedOut';
...
export declare const defaultMaxBacktracks = 200;
 ...
 */
export declare function isSafePattern(inputPattern: string, { atomicGroupOffsets: atomicGroupOffsetsInput, maxBacktracks, maxSteps, multiLine, timeout, caseInsensitive, dotAll, unicode, downgradePattern, }?: IsSafePatternConfig): RedosDetectorResult;
/**
