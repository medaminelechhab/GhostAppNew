...
import * as prism_clike from 'prismjs/components/prism-clike.js';
import * as prism_javascript from 'prismjs/components/prism-javascript.js';
import * as prism_markup from 'prismjs/components/prism-markup.js';
import * as prism_markdown from 'prismjs/components/prism-markdown.js';
import * as prism_c from 'prismjs/components/prism-c.js';
import * as prism_css from 'prismjs/components/prism-css.js';
import * as prism_objectivec from 'prismjs/components/prism-objectivec.js';
import * as prism_sql from 'prismjs/components/prism-sql.js';
import * as prism_python from 'prismjs/components/prism-python.js';
import * as prism_rust from 'prismjs/components/prism-rust.js';
import * as prism_swift from 'prismjs/components/prism-swift.js';
import * as prism_typescript from 'prismjs/components/prism-typescript.js';
import * as prism_java from 'prismjs/components/prism-java.js';
import * as prism_cpp from 'prismjs/components/prism-cpp.js';
...
// Avoid tree-shaking
const reifyPrismLanguages = () => ({
  Prism,
  languages: [prism_clike, prism_javascript, prism_markup, prism_markdown, prism_c, prism_css, prism_objectivec, prism_sql, prism_python, prism_rust, prism_swift, prism_typescript, prism_java, prism_cpp]
});
